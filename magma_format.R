...
frac[, outcome := "Fracture"]
str(frac)

dat <- rbind(bmd, frac)
dat[, log10p := -log10(P)]
dat[VARIABLE == "5_Aging_FDR_0_1", VARIABLE := "1_Aging"]
dat[VARIABLE == "6_TGFb_FDR_0_1", VARIABLE := "2_TGFb"]
dat[VARIABLE == "2_Common_DE_Aging_TGFb", VARIABLE := "3_Aging and TGFb"]
dat <- dat[VARIABLE %in% c("1_Aging", "2_TGFb", "3_Aging and TGFb")]
setnames(dat, "outcome", "Outcome")
